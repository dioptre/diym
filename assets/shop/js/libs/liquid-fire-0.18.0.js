...
;define("app/components/liquid-bind-c", 
  ["ember","exports"],
  function(__dependency1__, __exports__) {
    "use strict";
    var Ember = __dependency1__["default"];
...
;define("app/templates/components/liquid-bind-c", 
  ["exports"],
  function(__exports__) {
    "use strict";
    __exports__["default"] = Ember.HTMLBars.template((function() {
      ...
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          block(env, morph0, context, "liquid-with", [get(env, context, "value"), get(env, context, "as"), get(env, context, "boundValue")], {"class": get(env, context, "innerClass"), "use": get(env, context, "use"), "containerless": get(env, context, "containerless")}, child0, null);
          return fragment;
        }
      };
    }()));
...
;define("app/views/liquid-outlet", 
  ...
  function(__dependency1__, __dependency2__, __exports__) {
    ...
    __exports__["default"] = Ember.OutletView.superclass.extend({
...
container.register('component:liquid-bind-c', require('app/components/liquid-bind-c')['default']);
container.register('component:liquid-bind-c'.camelize(), require('app/components/liquid-bind-c')['default']);
...
container.register('template:components/liquid-bind-c', require('app/templates/components/liquid-bind-c')['default']);
container.register('template:components/liquid-bind-c'.camelize(), require('app/templates/components/liquid-bind-c')['default']);
